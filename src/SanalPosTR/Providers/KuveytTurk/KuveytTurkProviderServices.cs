...
namespace SanalPosTR.Providers.Ykb
{
    ...
    {
        public class KuveytTurk3DResult
        {
        ...
        public KuveytTurkProviderServices(Func<BankTypes, IProviderConfiguration> ziraatConfiguration) : base()
        {
        }
        ...
        private KuveytTurk3DResult Handler3D(string serverResponse)
        {
            KuveytTurk3DResult result = new KuveytTurk3DResult();
